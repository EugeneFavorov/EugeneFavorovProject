...
/* +++ crdbrw.p was humbly modified by (c)blodd converter v.1.09 on 6/30/2016 1:14pm +++ */
...
PROCEDURE AssignKau:
    ...
    IF NOT AVAILABLE kau THEN
    DO:
        RUN Fill-AlertSysMes IN h_tmess("","",1,"Запиcь в таблице kau заблокирована. " + CHR(32) + "~n" + CHR(32) + "Изменить приоритет невозможно").
