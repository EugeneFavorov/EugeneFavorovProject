...
/* +++ chk-role.p was humbly modified by (c)blodd converter v.1.09 on 7/15/2015 6:26am +++ */
...
DO:
   ...
   RUN Fill-AlertSysMes IN h_tmess("","",4,"Есть у клиента выгодоприобретатель или бенефициарный владелец?").
   mRoleKontr = (pick-value = "YES").
