...
/* +++ f-cust.p was humbly modified by (c)blodd converter v.1.09 on 7/15/2015 6:27am +++ */
...
------------------------------------------------------------------------------*/
   ...
   THEN
   DO:
      RUN chk-role.p("cust-corp", vRecId).
...
/* $LINTENV ='1ut' */
/* $LINTVSS ='$/ws2-tst/bq/' */
/* $LINTDATE='26/02/2015 09:39:09.285+04:00' */
/* $LINTUSER='KOMI' */
/* $LINTMODE='1' */
/* $LINTFILE='f-cust.p' */
/*prosignKHEHXzqFpew13KIvWSnS1g*/
