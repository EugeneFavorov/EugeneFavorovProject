...
/* +++ acct(crd2.p was humbly modified by (c)blodd converter v.1.09 on 1/8/2017 8:11pm +++ */
...
/*
    ...
    Copyright:  (C) 1992-1996 ТОО "Банковские информационные системы"
     ...
     modified: 01/12/2015 gsbis При наличии любой действующей блокировки в браузер выводится значение Блокирован 
...
DO:
   ...
   DO:
      {update.i &THIS_FRAME = "frAcct" &EXFILE = "acct(crd2.p.st1" {&*}} .
   END.
   ELSE 
      mAcctFltN = 0.
