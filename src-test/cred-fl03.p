...
/*
                and loan.cont-code  = "52-00-19940-КС@0000"
*/
                and loan.cust-cat   = "Ч"
...
PUT UNFORMATTED XLRow(0) XLCellHat("Все кредиты ФИЗИЧЕСКИХ ЛИЦ, номер кредитного договора которых содержит <КС> за " + STRING(end-date, "99.99.9999"), 13) XLRowEnd().
