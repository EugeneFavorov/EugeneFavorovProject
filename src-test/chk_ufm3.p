...
DEFINE VARIABLE document AS CHARACTER NO-UNDO.
...
iPar   = "ImpXlsUFM".
mA3    = "3".
mFraza = "Операции с согласования УФМ. Спящие клиенты. Операции сомнительны.".
...
REPEAT:
   ...
   DO:
      ...
      CREATE tt-inf.
      ASSIGN
         tt-inf.lname = REPLACE(REPLACE(LEFT-TRIM(CODEPAGE-CONVERT(ENTRY(1,mString,";"),"ibm866","1251"),'"'),'"""','"'),'""','"') 
         tt-inf.inn   = CODEPAGE-CONVERT(ENTRY(2,mString,";"),"ibm866","1251")
         tt-inf.an3   = mA3
         tt-inf.txt   = mFraza.
...
FOR EACH tt-inf EXCLUSIVE-LOCK:
   ...
   DO:
      ...
      DO:
         ...
         END.
         IF mAnalizOFM NE tt-inf.an3 THEN
         DO:
