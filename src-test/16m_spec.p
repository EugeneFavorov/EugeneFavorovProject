...
/* ====================================================================
"FOR EACH ACCT WHERE (ACCT.CLOSE-DATE EQ ?)
AND ACCT.CURRENCY EQ ''
AND CAN-DO('Кон138,КонЗдт,КонРез',ACCT.CONTRACT)
AND ACCT.ACCT NE '40702810103000025871     @0300'
AND ACCT.FILIAL-ID = '" + ФИЛИАЛ() + "'
NO-LOCK:"
==================================================================== */
