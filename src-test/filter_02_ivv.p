...
{globals.i}
{tmprecid.def}
def var f01_Error         as char no-undo.
...
FOR EACH tmprecid NO-LOCK, 
   ...
   */
   ...
   "K = " critK
   "Итого: X = " critX skip
   "F = A and B and C and F and G and H and J and ((not D) or (D and E))       " skip
   "Условие А: поле <БИК банка получателя> не содержится в списке our_bic_list;" skip
   "Условие B: счет получателя соответствует маскам счетов, указанным          " skip
   "           в списке cred_acc_f2_list;                                      " skip 
   "Условие С: в период времени с [текущая дата минус количество дней, заданное" skip
   "            параметром begin_date_delta_f2] до [текущая дата минус         " skip
   "            количество дней, заданное параметром end_date_delta_f2] не     " skip
   "            было ни одного исполненного платежа на этого получателя от     " skip
   "            этого отправителя;                                             " skip
   "Условие D : У Клиента подключена услуга <SMS-подтверждение>                " skip
   "Условие E : платеж на сумму меньшую, чем минимальная пороговая сумма,      " skip
   "Условие F : ИНН получателя отсутствует в списке emoney_services_inn_list;  " skip
   "Условие G : <БИК банка получателя> не удовл. маске exclude_bic_list        " skip
   "Условие H : Платеж на сумму больше или равную той, параметра min_pay_sum_f2" skip
   "Условие J : Код валюты платежа присутствует в списке currency_code         " skip
