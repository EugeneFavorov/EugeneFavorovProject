...
def VARIABLE mkind AS CHARACTER no-undo. 
...
DEFINE TEMP-TABLE tt-otchdg
   ...
   FIELD mkind    AS CHARACTER      /*транзакция*/
...
myStartDate = TODAY
myEndDate = TODAY
strTrans = 'ПДГ2,chdg_new,ChDG,093008++'
/* strTrans1 = 'ПДГ2,chdg_new,ChDG,093008++'
strTrans2 = 'ПДГ2,chdg_new,ChDG,093008++' */
...
{empty tt-otchdg}
/* message strTrans view-as alert-box. */
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="lll">
  <Table ss:ExpandedColumnCount="10" ss:ExpandedRowCount="29031978" x:FullColumns="1"
   x:FullRows="1">
   ...
   <Row ss:Index="1" ss:AutoFitHeight="0" ss:Height="56.25">
    <Cell ss:StyleID="s68"><Data ss:Type="String">Дата</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">Номер договора</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">Дата выдачи</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">ФИО</Data></Cell>
    <Cell ss:StyleID="s68"><Data ss:Type="String">ДГ</Data></Cell>
   </Row>
   '.
...
FOR EACH tt-otchdg NO-LOCK BREAK BY tt-otchdg.dateop BY tt-otchdg.sContCode:
 ...
 IF NOT CAN-DO("ПДГ*",tt-otchdg.mkind) THEN  tt-otchdg.mkind = 'ЧДГ'. 
   ELSE tt-otchdg.mkind = 'ПДГ'.
   ...
   PUT STREAM vvs UNFORMATTED '<Row ss:AutoFitHeight="0">'.
     ...
     PUT STREAM vvs UNFORMATTED tt-otchdg.sname + '</Data></Cell>\n'.                              /*5*/
      PUT STREAM vvs UNFORMATTED '<Cell><Data ss:Type="String">'.
     PUT STREAM vvs UNFORMATTED tt-otchdg.mkind  + '</Data></Cell>\n'.
