...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Титульный лист">\n
  <Table ss:ExpandedColumnCount="16" ss:ExpandedRowCount="1500000" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="def_b"><Data ss:Type="String">Срок хранения 5 лет</Data></Cell>\n
   </Row>\n
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="def_b"><Data ss:Type="String">Архивный индекс' + arhInd + '</Data></Cell>\n
   </Row>\n
'.
...
/*нужно ли печатать само подразделение в его титульном листе*/
DEF VAR selfprint AS LOG INIT FALSE NO-UNDO.
IF code.misc[2] EQ 'Да' THEN  
  selfprint = TRUE. 

/*если в на балансе подразделения не было документов, созданных*/
/*сотрудниками других подразделений, то не нужен selfprint     */
...
/*отделение, для которого составляется титульник*/
/*+ дата составления                            */
PUT STREAM vvs UNFORMATTED
'  <Row ss:AutoFitHeight="0">\n
   ...
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:StyleID="def_l"><Data ss:Type="String">за</Data></Cell>\n
    <Cell ss:StyleID="dat"><Data ss:Type="String">' + STRING(end-date,'99.99.9999') + ' г.' + '</Data></Cell>\n
   </Row>\n
   <Row>\n
   </Row>\n
'.
...
'  <Row ss:AutoFitHeight="0">\n
    ...
    <Cell ss:MergeAcross="2" ss:StyleID="summ"><Data ss:Type="String">по балансовым счетам</Data></Cell>\n
    <Cell ss:MergeAcross="2" ss:StyleID="summ"><Data ss:Type="String">по внебалансовым счетам</Data></Cell>\n
   </Row>\n
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="left_g"><Data ss:Type="String">Бухгалтерские документы на сумму</Data></Cell>\n
   ...
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="left_g"><Data ss:Type="String">в т.ч. по операциям с ин. валютой</Data></Cell>\n
   ...
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="left_g"><Data ss:Type="String">Хранятся в электронном виде</Data></Cell>\n
   ...
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="7" ss:StyleID="left_g"><Data ss:Type="String">Хранятся в отдельных папках:</Data></Cell>\n
   </Row>\n
'.

IF CAN-DO(code.val,'Докдн') THEN
  PUT STREAM vvs UNFORMATTED 
'  <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="left_b"><Data ss:Type="String">Кассовые документы</Data></Cell>\n
   ...
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="left_b"><Data ss:Type="String">Документы дня</Data></Cell>\n
...
IF CAN-DO(code.val,'Агент') THEN
  PUT STREAM vvs UNFORMATTED 
'  <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="left_b"><Data ss:Type="String">Агентские вознаграждения</Data></Cell>\n
...
IF CAN-DO(code.val,'Подотчет') THEN
  PUT STREAM vvs UNFORMATTED 
'  <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="left_b"><Data ss:Type="String">Подотчетные суммы</Data></Cell>\n
...
IF CAN-DO(code.val,'Хоздок') THEN
	PUT STREAM vvs UNFORMATTED
'  <Row ss:AutoFitHeight="0">\n
	    <Cell ss:MergeAcross="1" ss:StyleID="left_b"><Data ss:Type="String">Хозяйственные операции</Data></Cell>\n
...
PUT STREAM vvs UNFORMATTED
'<Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="7" ss:StyleID="left_g"><Data ss:Type="String">Хранятся в электронном виде</Data></Cell>\n
   </Row>\n
'.
...
IF CAN-DO(code.val,'Докдн') THEN
  PUT STREAM vvs UNFORMATTED 
'  <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="left_b"><Data ss:Type="String">Бухгалтерские документы</Data></Cell>\n
...
/*
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="right_i"><Data ss:Type="String">из них по автоматическим транзакциям*</Data></Cell>\n
   ...
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="right_i"><Data ss:Type="String">в т.ч. по операциям с ин. валютой</Data></Cell>\n
...
FOR EACH tt-kko 
  WHERE (IF selfprint AND allKKO NE iFilID
    ...
    /*считаем итоги для каждого отделения*/
      ...
      '<Row ss:AutoFitHeight="0">\n
       ...
       <Row ss:AutoFitHeight="0" ss:Height="15.75">\n
        <Cell ss:MergeAcross="7" ss:StyleID="left_ino"><Data ss:Type="String">Хранение документов осуществляется в местах осуществления операций</Data></Cell>\n
       </Row>\n
      '.
...
IF CAN-DO(tt-kko.shiv,'Докдн') THEN
  PUT STREAM vvs UNFORMATTED 
'  <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="left_b"><Data ss:Type="String">Кассовые документы</Data></Cell>\n
    <Cell ss:MergeAcross="2" ss:StyleID="summ"><Data ss:Type="String">' + TRIM(STRING(mKas-b-all,'>>>,>>>,>>>,>>9.99')) + r + '</Data></Cell>\n
...
IF CAN-DO(tt-kko.shiv,'Агент') THEN
  PUT STREAM vvs UNFORMATTED 
'  <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="left_b"><Data ss:Type="String">Агентские вознаграждения</Data></Cell>\n
    <Cell ss:MergeAcross="2" ss:StyleID="summ"><Data ss:Type="String">' + TRIM(STRING(mAg-p-b-all,'>>>,>>>,>>>,>>9.99')) + r + '</Data></Cell>\n
...
IF CAN-DO(tt-kko.shiv,'Подотчет') THEN
  PUT STREAM vvs UNFORMATTED 
'  <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1" ss:StyleID="left_b"><Data ss:Type="String">Подотчетные суммы</Data></Cell>\n
    <Cell ss:MergeAcross="2" ss:StyleID="summ"><Data ss:Type="String">' + TRIM(STRING(mOt-p-b-all,'>>>,>>>,>>>,>>9.99')) + r + '</Data></Cell>\n
...
IF CAN-DO(tt-kko.shiv,'Хоздок') THEN
  PUT STREAM vvs UNFORMATTED
'  <Row ss:AutoFitHeight="0">\n
      <Cell ss:MergeAcross="1" ss:StyleID="left_b"><Data ss:Type="String">Хозяйственные операции</Data></Cell>\n
      <Cell ss:MergeAcross="2" ss:StyleID="summ"><Data ss:Type="String">' + TRIM(STRING(mHoz-p-b-all,'>>>,>>>,>>>,>>9.99')) + r + '</Data></Cell>\n
...
'<Row ss:AutoFitHeight="0">\n
   ...
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1"><Data ss:Type="String">Документы сброшюрованы и подшиты</Data></Cell>\n
    <Cell ss:Index="5" ss:MergeAcross="2" ss:StyleID="dat"/>\n
   </Row>\n
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:Index="5" ss:MergeAcross="2" ss:StyleID="def_c"><Data ss:Type="String">( подпись)</Data></Cell>\n
   </Row>\n
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:MergeAcross="1"><Data ss:Type="String">С данными бухгалтерского учета сверено</Data></Cell>\n
    <Cell ss:Index="5" ss:MergeAcross="2" ss:StyleID="dat"/>\n
   </Row>\n
   <Row ss:AutoFitHeight="0">\n
    <Cell ss:Index="5" ss:MergeAcross="2" ss:StyleID="def_c"><Data ss:Type="String">( подпись)</Data></Cell>\n
