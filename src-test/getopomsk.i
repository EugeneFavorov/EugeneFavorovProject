...
PROCEDURE LoadPostMfr:
   ...
   DO:
      ...
      DO:
         ...
         PUT UNFORMATTED "создан ДР W4_export на op = " STRING(op.op) + " значение = " + STRING(NOW,"99.99.9999 HH:MM:SS") SKIP.
      END.
   END.
   ...
   DO:
      ...
      DO:
         op.op-status       = "ВПЦ".
         op-entry.op-status = "ВПЦ". 
         IF AVAIL(op-entry2) THEN op-entry2.op-status = "ВПЦ".
      END.
   END.
