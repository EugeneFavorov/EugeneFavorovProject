...
FOR EACH tmprecid NO-LOCK,
	...
	IF AVAIL loan-acct THEN DO:
	        find first acct of loan-acct where acct.close-date = ? or acct.close-date > end-date no-lock no-error.
...
FOR EACH otch NO-LOCK BY otch.cont_code BY cont_code:
    ...
    PUT STREAM vvs UNFORMATTED ISO-DATE(DATETIME(otch.opendate)) + '</Data></Cell>\n'.
    PUT STREAM vvs UNFORMATTED  '<Cell><Data ss:Type="DateTime">'.
