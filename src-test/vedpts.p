...
put stream vvs unformatted
    ...
    FOR EACH loan WHERE loan.open-date >= beg-date
        AND (loan.cont-type BEGINS 'АВТО' OR loan.cont-type BEGINS 'Avto') 
        ...
        NO-LOCK:
            ...
            IF loan.close-date <> ? THEN mDateClose = STRING(loan.close-date,"99.99.9999").
                ELSE mDateClose = STRING("","x(10)").
