...
def var sumproc2 as decimal no-undo.
...
/* 0 */
        ...
        UpdateSigns(loan.class-code, loan.contract + ',' + loan.cont-code, "otst_od7", string(sumod), ?) NO-ERROR.   
        UpdateSigns(loan.class-code, loan.contract + ',' + loan.cont-code, "otst_od0", string(pp-sum), ?) NO-ERROR.
        sumod = sumod + pp-sum.                       
        ...
        for each all-sum-par where lookup(string(all-sum-par.par),listproc2) > 0 no-lock:
            sumproc2 = sumproc2 + all-sum-par.summ.         
        end.
        
        UpdateSigns(loan.class-code, loan.contract + ',' + loan.cont-code, "otst_proc10", string(sumproc), ?) NO-ERROR.
        UpdateSigns(loan.class-code, loan.contract + ',' + loan.cont-code, "otst_proc4", string(sumproc2), ?) NO-ERROR.   
        sumproc = sumproc + sumproc2.     
