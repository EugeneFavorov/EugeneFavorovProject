...
DEFINE VARIABLE sumzay  AS DECIMAL NO-UNDO.
DEFINE VARIABLE nedospis  AS DECIMAL NO-UNDO.
DEFINE VARIABLE strpriznak   aS CHARACTER NO-UNDO.
...
DEFINE TEMP-TABLE tt-otchdg
   ...
   FIELD sumzay  AS DECIMAL          /* сумма по заявлению */
   FIELD nedospis  AS CHAR          /* недосписано-пересписано */
   FIELD dateclose AS DATE            /* дата  закрытия 40817 */
   FIELD loan40817 AS CHARACTER            /* Счет связан с КД */
   FIELD ostKredRasp AS DECIMAL
   FIELD strpriznak AS CHARACTER            /* допрек со связанного КД */
...
FOR EACH op WHERE 
   ...
   DO:
      ...
      FOR EACH loan-int OF op-entry NO-LOCK:
		 ...
		 dDateLoan = loan.open-date.
            	 sumzay = decimal(GetXattrValueEx( "loan", 'Кредит,' + loan.cont-code , "dg_summ_dosr_g", "0")).
	 end.
         LEAVE.
      END.
      ...
      DO:
         ...
         NO-LOCK:
            ...
            strpriznak = strpriznak + GetXAttrValue("loan",bloan.contract + "," + bloan.cont-code, "priznak") + ','.
         END.  
      END.
      ...
      ASSIGN
         ...
         tt-otchdg.sumzay    = sumzay
         tt-otchdg.strpriznak = strpriznak
         .
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="lll">
  <Table ss:ExpandedColumnCount="25" ss:ExpandedRowCount="29031978" x:FullColumns="1"
   x:FullRows="1">
   ...
   <Row ss:Index="1" ss:AutoFitHeight="0" ss:Height="56.25">
    ...
    <Cell ss:StyleID="s69"><Data ss:Type="String">Сумма по заявлению</Data></Cell>
    <Cell ss:StyleID="s69"><Data ss:Type="String">Сумма</Data></Cell>
    <Cell ss:StyleID="s69"><Data ss:Type="String">Недосписано (+) Пересписано (-)</Data></Cell>
    ...
    <Cell ss:StyleID="s67"><Data ss:Type="String">Допрек priznak на связанном КД</Data></Cell>
...
FOR EACH tt-otchdg NO-LOCK BREAK BY tt-otchdg.dateop BY tt-otchdg.sContCode:
   ...
   nedospis = tt-otchdg.sumzay - tmpSum.
   tt-otchdg.nedospis = STRING(tt-otchdg.nedospis,"->,>>>,>>>,>>9.99").
   IF tt-otchdg.ost > 0 THEN tt-otchdg.nedospis = ''.
   ...
   PUT STREAM vvs UNFORMATTED '<Row ss:AutoFitHeight="0">'.
     ...
     PUT STREAM vvs UNFORMATTED  '<Cell><Data ss:Type="String">'.
     PUT STREAM vvs UNFORMATTED STRING(tt-otchdg.sumzay,"->,>>>,>>>,>>9.99") + '</Data></Cell>\n'.
     PUT STREAM vvs UNFORMATTED  '<Cell><Data ss:Type="String">'.
     PUT STREAM vvs UNFORMATTED STRING(tmpSum,"->,>>>,>>>,>>9.99") + '</Data></Cell>\n'.
     PUT STREAM vvs UNFORMATTED  '<Cell><Data ss:Type="String">'.
     PUT STREAM vvs UNFORMATTED tt-otchdg.nedospis + '</Data></Cell>\n'.
     PUT STREAM vvs UNFORMATTED  '<Cell><Data ss:Type="String">'.
     ...
     PUT STREAM vvs UNFORMATTED  '<Cell><Data ss:Type="String">'.
     PUT STREAM vvs UNFORMATTED TRIM(tt-otchdg.strpriznak," ,") + '</Data></Cell>\n'. 
     PUT STREAM vvs UNFORMATTED  '<Cell><Data ss:Type="String">'.
