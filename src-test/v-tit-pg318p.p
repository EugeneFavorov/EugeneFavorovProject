...
PROCEDURE PrintRep:
   ...
   FOR EACH ttRep.
      if ttRep.currency = "" then ttRep.currency = "643". 
   END.
...
но при этом принесены клиентом в одном чеке.*/
   FOR EACH bttRepOp.
       for each ttRepOp where  ttRepOp.currency eq bttRepOp.currency
                          and  ttRepOp.OpDate   eq bttRepOp.OpDate
                          and  ttRepOp.Acct     eq bttRepOp.Acct
                          ...
                          and  ttRepOp.op-kind  eq bttRepOp.op-kind
