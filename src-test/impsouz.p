...
fname = '/data/home2/bis/quit41d/imp-exp/soyuz/in/' + 'plus_' + STRING(DAY(sOpDate),"99") + STRING(MONTH(sOpDate),"99") + STRING(YEAR(sOpDate),"9999") + '.csv'.
iInt = 0.
...
FOR EACH ttOp WHERE ttOp.in-sNewSum > 0:
    ...
    END.
                                                ...
                                                RUN ex-trans.p(INPUT 'persouzed', 
                                                        INPUT TODAY, 
