...
ASSIGN
   mFilList  = "0000,0300"
   mTranList = "012szauto,028cl1_3auto,012vostrauto".
...
DO mInt1 = 1 TO NUM-ENTRIES(mFilList):
   ...
   mOSCommamd = "cp " + "./" + mCurrentFile + " /home2/bis/imp-exp/log/dps/" + mCurrentFile.
   OS-COMMAND SILENT VALUE(mOSCommamd).
END.
...
/* message "d" view-as alert-box. */
      RUN VALUE(op-kind.proc + ".p") ((TODAY),RECID(op-kind)) NO-ERROR.
