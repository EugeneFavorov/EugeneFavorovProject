      ...
      DO mIi = 1 TO NUM-ENTRIES(t-type):
         ...
         DO WHILE TRUE
          ...
          DO mCii = 1 TO NUM-ENTRIES (mLoanList):
            ...
            FIND FIRST loan-acct OF loan WHERE loan-acct.acct-type = 'loan-dps-t' NO-LOCK NO-ERROR.
            ...
            IF AVAIL signs THEN DateNewAcct = signs.date-value + 1.
