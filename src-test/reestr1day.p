...
FOR EACH op WHERE
    op.op-date = end-date 
    AND (op.op-kind = 'persouzed' or op.op-kind begins 'perechS' or op.op-kind = '04012')
...
sName = 'Реестр на сумму ' + STRING(dSum, ">>>>>>>>>>>9.99") + CHR(10) + ' Документов ' + STRING(iCount) + CHR(10) + 'Выгружаем в Союз'.
...
END.
ELSE DO:
	ffname = "/data/home2/bis/quit41d/imp-exp/soyuz/out/" + fname.
