    ...
    /* вставка информации о банке = залогодержателе */
        ...
        IF mAPPLICANTID EQ 5 THEN  */
            ASSIGN 
                ...
                AR.STREET       = "Колпачный переулок" /* Улица */
                AR.HOUSE        = "6" /* Дом */
                AR.BUILDING     = "стр. 5"
                AR.APARTMENT    = "II,к 5"
            .
        ...
        ELSE
            ASSIGN 
                ...
                AR.BUILDING     = AR1.BUILDING
                AR.APARTMENT    = AR1.APARTMENT
            .
            */
        /**/
        VALIDATE AR.
...
*/        
        ...
        ASSIGN
            RO.CLIENTID  = CNT_RO
            RO.NAMEFULL  = 'Общество с ограниченной ответственностью "Холдинг Солнечный"'
            RO.OGRN      = "1147746379770"
            RO.INN       = "7709951263"
            RO.ADDRESSID = CNT_AR
        .
        ELSE
