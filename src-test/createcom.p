...
FOR EACH bop WHERE bop.op-date EQ date1
    ...
    FOR EACH bop-entry WHERE bop-entry.op-date EQ bop.op-date
                         ...
                         AND can-do('!30223*,!40817*,!40821*,402*,405*,406*,407*,408*', bop-entry.acct-db)
...
END.
                                                          ...
                                                          /*IF AVAIL btmpsigns
                                                               AND btmpsigns.xattr-value NE ''
                                                          THEN PUT STREAM ws UNFORMATTED string(btmpsigns.xattr-value, "x(12)") + " | " + string(i3, ">>>>>>9") + " | " + chr(13) + chr(10).
                                                          ELSE DO:*/ IF AVAIL btmpsigns2
                                                                          AND btmpsigns2.xattr-value NE ''
                                                                          AND btmpsigns2.xattr-value = "’¥áâ-¤à ©¢"
                                                                          AND date1 <= btmpsigns2.since + 90
