...
PROCEDURE XLProtokol:
    ...
    THEN DO:
        IF (shFilial EQ "0500")
        THEN PUT UNFORMATTED XLHead("ul", "CCNCCDNCCNC", "213,53,103,200,96,71,103,89,122,70,171").
        ELSE PUT UNFORMATTED XLHead("ul", "CNCCDNCCNC",  "213,103,200,96,71,103,89,122,70,171").
    ...
    FOR EACH ttKauCrt
        ...
        cXL = XLCell(iAcct)
            ...
            + XLNumCell(IF (ttKauCrt.comissia EQ 0.0) THEN ? ELSE ttKauCrt.comissia)
