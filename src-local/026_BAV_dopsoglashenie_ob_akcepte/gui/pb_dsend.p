...
/* +++ pb_dsend.p was humbly modified by (c)blodd converter v.1.11 on 4/17/2017 12:01pm +++ */
...
LAST loan-acct
    ...
    THEN DO:
        ...
        PUT UNFORMATTED XLHead(STRING(end-date, "99.99.9999"), "ICCCCCCDDC", "28,59,62,250,150,150,250,90,90,141").
        PUT UNFORMATTED XLRowH(0, 34) XLCellHat("Ведомость закрытых Дополнительных соглашений по сроку", 9) XLRowEnd().
