...
/* +++ pp-op.p was humbly modified by (c)blodd converter v.1.09 on 9/19/2016 7:56am +++ */
...
PROCEDURE CheckAcctOE PRIVATE:
   ...
   IF iSide = "db" THEN DO:
      RUN NotifyBankruptAcct IN h_acct (bAcct.acct,
                                        bAcct.currency,
                                        iObject:BUFFER-FIELD("acct-cr"):BUFFER-VALUE,
                                        gend-date,
                                        YES).
   ...
   DO:
       ...
       DO:
           ...
           DO ON ERROR  UNDO,RETRY
              ...
              PAUSE 0.
              {wait_for.i &THIS_FRAME = "sss1" &ENTRY_FOCUS = "mTxt" &EXFILE = "pp-op.p.wf1" {&*}} .
           END.
           /*
           {wait_for.i 
             &THIS_FRAME = "sss1" 
...
/* $LINTVSS ='$/ws2-tst/bq/' */
/* $LINTUSER='krok' */
/* $LINTDATE='28/04/2016 13:07:02.980+04:00' */
/*prosignGhJmeEXADc9AAclpKK+7sw*/
/* --- pp-op.p was humbly modified by (c)blodd converter v.1.09 on 9/19/2016 7:56am --- */
