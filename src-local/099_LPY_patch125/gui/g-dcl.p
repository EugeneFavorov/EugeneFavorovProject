...
/* +++ g-dcl.p was humbly modified by (c)blodd converter v.1.09 on 11/11/2016 6:35am +++ */
...
DO TRANSACTION WITH FRAME opreq ON ENDKEY UNDO, LEAVE ON ERROR UNDO, LEAVE:
   ...
   BREAK BY
      ...
      DO:       
        ...
        DO:
          RUN Fill-AlertSysMes IN h_tmess("","",-1,"Вклад мультивалютный." + CHR(32) + "~n" + CHR(32) + "Для закрытия этого вклада выбирете другую" + CHR(32) + "~n" + CHR(32) + "транзакцию и мультивалютный охватываюший договор." + CHR(32) + "~n").
      ...
      DO:
         RUN Fill-AlertSysMes IN h_tmess("","",-1,"Договор закрывается раньше срока." + CHR(32) + "~n" + CHR(32) + "Воспользуйтесь транзакцией досрочного закрытия вклада.").
      ...
      DO:
         RUN Fill-AlertSysMes IN h_tmess("","",-1,"Плановая дата закрытия не может быть " + CHR(32) + "~n" + CHR(32) + "больше реальной даты закрытия вклада.").
            ...
            DO:
               ...
               DO:
                  ...
                  DO:
                     ...
                     RUN Fill-AlertSysMes IN h_tmess("","",-1,"~n" + CHR(32) + STRING(msg) + CHR(32) + FILL("~n",1)).
                     ...
                     CASE RESULT:
                        ...
                        WHEN {&egmissingcorracct} THEN
                           {next_prompt.i "vcorr-acct" }
                        OTHERWISE {next_prompt.i "op.ben-acct" }
                     END CASE.
                  ...
                  DO:
                     ...
                     DO:
                        ...
                        RUN Fill-AlertSysMes IN h_tmess("","",4,"~n" + CHR(32) + "Неверно заданы банковские реквизиты. Продолжить?" + CHR(32) + FILL("~n",1)).
