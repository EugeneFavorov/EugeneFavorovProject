...
/* +++ nach_plt.p was humbly modified by (c)blodd converter v.1.09 on 10/5/2016 2:03pm +++ */
...
DEF VAR mOst         AS CHAR           NO-UNDO. /* код субостатка вклада*/
DEF VAR mNach        AS CHAR           NO-UNDO. /* код начисления % по субостатку*/
...
ASSIGN
   mOst  = ENTRY(3,str-kau)
   mNach = IF mOst = "ОстВклВ"
           THEN  "НачПрВ"
           ELSE  "НачПрС1".
...
/* $LINTVSS ='$/ws2-tst/bq/' */
/* $LINTUSER='fiyu' */
/* $LINTDATE='15/08/2016 11:36:50.731+03:00' */
/*prosignMsJn44FiILkjDojgPO35gg*/
/* --- nach_plt.p was humbly modified by (c)blodd converter v.1.09 on 10/5/2016 2:03pm --- */
