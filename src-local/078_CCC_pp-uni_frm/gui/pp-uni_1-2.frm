...
/* +++ pp-uni_1-2.frm was humbly modified by (c)blodd converter v.1.11 on 7/6/2017 2:33pm +++ */
...
/*
   ...
   Parameters:
     ...
     Modified: 23/08/2012 kraw (0132548) между подписями 15 мм
...
&ENDIF
     ...
     SKIP(1)
     "Уникальный"                                SKIP
     "идентификатор составителя " uni-ident-send SKIP(3)
     &ENDIF
     ...
     "Поступ. в банк плат." AT 1        "    Cписано со сч. плат."                 "└─────────┘" AT 75 skip(2)
                                                                                                                 ...
                                                                                                                 "┌──┐" AT 75
     NameOrder Format "x(22)" op.doc-num Format "x(10)" AT 23 theDate Format "x(10)" AT 35 PayType Format "x(16)" AT 52 "│" AT 75 SPACE(0) mPokST FORMAT "x(2)" SPACE(0) "│"
     "                               ────────────────    ─────────────────"                                       "└──┘" AT 75
     ...
     "                                               │      │" mUIN1 format "x(9)" "│         │" SPACE(0) skip
     "                                               │Код   │" mUIN2 format "x(9)" "│Рез.поле │" SPACE(0) mPPDate skip
     "Получатель                                     │      │" mUIN3 format "x(9)" "│         │" SPACE(0) skip
     "────────────────────┬─────────────┬────┬───────┴────┬─┴───────────┴──┬──────┴───┬─────" skip
