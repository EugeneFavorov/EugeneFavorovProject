...
/*
ПроцОпер         Процедура поиска операций      ext-fillop.p
ПроцСчет         Процедура определения оборотов ext-acctpos.p
ПроцСчПоиск      Процедура поиска счета         ext-findact.p
ПроцСчПоискКли   Процедура поиска счета по клие ext-findactex.p
*/
