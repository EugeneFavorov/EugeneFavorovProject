...
/* +++ rep-bl-fl-cr.p was humbly modified by (c)blodd converter v.1.09 on 5/30/2016 7:29am +++ */
...
/*   AND acct.filial-id  EQ shFilial*/
   ...
   PUT STREAM out-stream UNFORMATTED '    <Cell ss:StyleID="s66"><Data ss:Type="String">' + acct.acct + '</Data></Cell>' SKIP.
