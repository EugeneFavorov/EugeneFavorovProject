...
/* +++ crdex.i was humbly modified by (c)blodd converter v.1.09 on 7/26/2016 8:21am +++ */
      ...
      DO:
         ...
         ELSE DO:
            DO:
               ...
               RUN Fill-AlertSysMes IN h_tmess("","",4,"Вы не хотите проводить проводку по картотеке(Да) или просто откатываетесь(Нет) ?").
